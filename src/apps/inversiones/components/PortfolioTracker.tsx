...
const MOCK_ETBS = [
  ...
  { id: 'etb_pev', name: 'Paldea Evolved Elite Trainer Box', set: 'Paldea Evolved', image: 'https://product-images.tcgplayer.com/fit-in/437x437/494498.jpg', marketPrice: 42 },
  { id: 'etb_sv1', name: 'Scarlet & Violet Base Elite Trainer Box', set: 'Scarlet & Violet Base', image: 'https://product-images.tcgplayer.com/fit-in/437x437/484557.jpg', marketPrice: 40 },
  { id: 'etb_crz', name: 'Crown Zenith Elite Trainer Box', set: 'Crown Zenith', image: 'https://product-images.tcgplayer.com/fit-in/437x437/455799.jpg', marketPrice: 65 },
  { id: 'etb_sit', name: 'Silver Tempest Elite Trainer Box', set: 'Silver Tempest', image: 'https://product-images.tcgplayer.com/fit-in/437x437/287042.jpg', marketPrice: 45 },
