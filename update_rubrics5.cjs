...
const startMarker = '// COMPETENCIAS PROFESIONALES';
const endMarker = '  // FRAMEWORK & METODOLOG';
...
// Find the line with the equal signs above endMarker
const endLineStartIndex = code.lastIndexOf('// =============', endIndex);

const part1 = code.substring(0, startIndex);
const part2 = code.substring(endLineStartIndex);
...
let newCode = part1 + replacementText + part2;

// regex to remove the ss_trabajo_equipo object from softskills
